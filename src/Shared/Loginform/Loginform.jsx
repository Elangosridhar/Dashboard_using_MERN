        ...
        <div className="flex justify-center">
          ...
          <form>
            <div className="mb-4">
              ...
              <input  name="employee_email"  type="email"  onChange={handleChange} required className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />
            </div>
            <div className="mb-4 relative">
              <label  className="block text-[#7dd3fc] mb-2">Password</label>
              <input  name="password"  type={type}  onChange={handleChange} required className="w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" />
            ...
            <button type="button" onClick={() => login(formdata)} className="relative flex justify-center w-full px-4 py-2 text-sm font-medium text-white bg-[#d946ef] border border-transparent rounded-md group hover:bg-[#878a8d]">Sign in</button>
          </form>
        </div>
      </div>
    </div>
